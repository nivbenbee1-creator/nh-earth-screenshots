 ...
 * Fixed: Camera movement, UI visibility, and Pin appearance.
 */
...
<body>
  ...
  <script>
    ...
    scene.globe.enableLighting = false; // תמיד אור יום
    scene.highDynamicRange = true; 
    scene.globe.showGroundAtmosphere = false;
    scene.globe.maximumScreenSpaceError = 2.0; 
    viewer.resolutionScale = 1.0;

    // הוספת סיכה אדומה בולטת
    const pinEntity = viewer.entities.add({
      ...
      billboard: {
        ...
        width: 80, height: 80, // פין גדול יותר
        heightReference: Cesium.HeightReference.CLAMP_TO_GROUND, // נצמד לקרקע
...
async function main() {
  ...
  // המתנה קצרה לוודא שהסקריפט נטען
